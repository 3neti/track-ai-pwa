    ...
    */
    ...
    'scenarios' => [
        ...
        'full_lifecycle' => [
            ...
            'description' => 'Submit progress and poll the automatically triggered AI workflow to completion.',
            'current_milestone' => 'Foundation',
        ...
        'dpwh_field_day' => [
            ...
            'description' => 'Full field engineer day: check-in, upload docs, submit progress, poll automatic AI, check-out.',
            'current_milestone' => 'Foundation',
