...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/progress-reports/{progressReport}/files', [ProjectProgressController::class, 'files'])->name('api.progress-reports.files');
    Route::get('/progress-reports/{progressReport}/certificate/download', [ProjectProgressController::class, 'downloadCertificate'])->name('api.progress-reports.certificate.download');
